...
#maybe dar pra fazer reload
    ...
    #LINHA 1
    linhas.append(criarLinhaDeTexto(padrao, 'Digite a primeira coordenada:', lbl_font, row = 1, columnspan=3))
    #LINHA 2
    linhas.append(criarLinhaDeCoordenadas(padrao, row = 2))
    #LINHA 3
    linhas.append(criarLinhaDeTexto(padrao, 'Digite a segunda coordenada:', lbl_font, row = 3, columnspan=3))
    #LINHA 4
